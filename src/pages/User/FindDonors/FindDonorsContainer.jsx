...
const FindDonorsContainer = () => {
  ...
  return (
    <div id="find-donors" className="relative overflow-hidden pb-12 min-h-[730px]">
      <motion.div
        className="main-container relative z-40 pb-8"
        initial="hidden"
        animate="visible"
        ...
        <AnimatePresence>
          {isFilterOpen && (
            <motion.div className="w-full" initial="hidden" animate="visible" exit="hidden" variants={filterVariants}>
              <div className="p-6 mt-4 bg-white rounded-lg shadow-lg border border-gray-100">
