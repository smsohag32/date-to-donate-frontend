...
const Footer = () => {
   return (
      <footer className="bg-white border-t border-t-rose-100 shadow">
         <div className="main-container px-4 py-12">
            {/* Top section with newsletter */}
            <div className="flex flex-col md:flex-row justify-between items-center bg-red-50 rounded-xl p-6 mb-10">
               <div className="mb-4 md:mb-0">
                  ...
                  <p className="text-gray-600 mt-1">Subscribe to receive updates on blood drives and donation opportunities</p>
               </div>
               <div className="flex w-full items-center md:w-auto">
                  ...
                  />
                  <Button className="rounded-l-none py-4.5 bg-red-600 hover:bg-red-700">
                     Subscribe
                  </Button>
               </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
               {/* About section */}
               <div>
                  <div className="font-bold text-lg mb-4"><span>About</span>    <NavLink to="/" className="flex items-center mt-3 space-x-2">
                     <LogoRegular className="w-5" />   <p><span className="text-[#FF2156] tracking-tighter font-medium text-lg ">Dare </span>
                        <span className='text-[#595959] font-normal'>To</span>   <span className="text-[#FF2156] tracking-tighter font-medium text-lg ">  Donate</span></p> </NavLink></div>
                  <p className="text-gray-600 mb-4">
                     We connect blood donors with patients in need, making the donation process simple and accessible for everyone.
                  </p>
                  ...
                  <ul className="space-y-3">
                     <li className="flex items-start">
                        ...
                        <span className="text-gray-600">
                           123 Lifesaver Street, Medical District, City, Country
                        </span>
                     </li>
